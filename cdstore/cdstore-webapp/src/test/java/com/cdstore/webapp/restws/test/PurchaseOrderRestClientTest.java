...
public class PurchaseOrderRestClientTest extends TestCase {
	...
	public void testPurchaseCreditCardFail() {
		User user = new User();
		user.setUserId("9");
		/*
		 * user.setFirstName("Ronak"); user.setLastName("Chaudhari");
		...
		String purchaseStatus1 = purchaseOrderRestClient
				.purchase(purchaseOrder);
		String purchaseStatus2 = purchaseOrderRestClient
				.purchase(purchaseOrder);
		String purchaseStatus3 = purchaseOrderRestClient
				.purchase(purchaseOrder);
		String purchaseStatus4 = purchaseOrderRestClient
				.purchase(purchaseOrder);
		String purchaseStatus5 = purchaseOrderRestClient
				.purchase(purchaseOrder);
		Assert.assertEquals("creditcarderror", purchaseStatus5);
